      ...
      <div class="page-content px-25">
        ...
        <div class="card my-25">
          <form action="productHandler.php?id=<?php echo $_GET["id"] ?>" method="post" enctype="multipart/form-data" class="form-content">
            ...
            <div class="form-group mb-15">
              <label for="lstSize">Size</label>
              <select name="lstSize" id="lstSize" required>
                <?php
            ...
            <div class="form-group mb-15">
              ...
              <select name="lstColor" id="lstColor" required>
                <?php
                $colors = array("White", "Black", "Gray", "Orange", "Blue", "Red", "Brown", "Green", "Purple", "Yellow", "Multi-Color", "Other");
